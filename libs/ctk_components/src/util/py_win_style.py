...
if IS_WINDOWS:
    ...
    def ChangeDWMAttrib(*args, **kwargs):
        pass

    def ChangeDWMAccent(*args, **kwargs):
        pass

    def ExtendFrameIntoClientArea(*args, **kwargs):
        pass
    ...
    class apply_style:
        def __init__(self, window, style: str) -> None:
            print(f"[INFO] apply_style ignorado ({style}) — exclusivo do Windows.")

    class change_header_color:
        def __init__(self, window: Any, color: str) -> None:
            print(f"[INFO] change_header_color ignorado ({color}) — exclusivo do Windows.")

    class change_border_color:
        def __init__(self, window: Any, color: str) -> None:
            print(f"[INFO] change_border_color ignorado ({color}) — exclusivo do Windows.")

    class change_title_color:
        def __init__(self, window: Any, color: str) -> None:
            print(f"[INFO] change_title_color ignorado ({color}) — exclusivo do Windows.")

    class set_opacity:
        def __init__(self, widget: int, value: float = 1.0, color: str = None) -> None:
            print(f"[INFO] set_opacity ignorado ({value}) — exclusivo do Windows.")